...
use valkyrie::governance::query_msgs::StakerStateResponse as ValkyrieStakerResponse;
use valkyrie::lp_staking::query_msgs::StakerInfoResponse as ValkyrieStakerInfoResponse;
        ...
        match &request {
            ...
            QueryRequest::Wasm(WasmQuery::Smart { contract_addr, msg }) => {
                match from_binary(msg).unwrap() {
                    ...
                    MockQueryMsg::StakerState { address } => {
                        let balance = self.read_token_balance(contract_addr, address);
                        SystemResult::Ok(ContractResult::from(to_binary(&ValkyrieStakerResponse {
                            balance,
                            share: balance
                                .multiply_ratio(100u128, self.token_querier.balance_percent),
                            votes: vec![],
