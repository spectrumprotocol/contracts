...
use spectrum_protocol::spec_compound_farm::{
...
pub fn instantiate(
    ...
    store_config(
        ...
        &Config {
            ...
            spectrum_staking: deps.api.addr_canonicalize(&msg.spectrum_staking)?,
...
fn query_config(deps: Deps) -> StdResult<ConfigInfo> {
    ...
    let resp = ConfigInfo {
        ...
        spectrum_staking: deps.api.addr_humanize(&config.spectrum_staking)?.to_string(),
