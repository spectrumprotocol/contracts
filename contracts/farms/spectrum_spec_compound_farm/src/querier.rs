...
use spectrum_protocol::spec_farm::{QueryMsg as SpecFarmQueryMsg, RewardInfoResponse};
use spectrum_protocol::gov::{QueryMsg as SpecGovQueryMsg, BalanceResponse as SpecGovBalanceResponse};
...
pub fn query_spec_reward_info(
    ...
    deps.querier.query(&QueryRequest::Wasm(WasmQuery::Smart {
        ...
        msg: to_binary(&SpecFarmQueryMsg::reward_info {
...
pub fn query_spec_gov_balance(
    deps: Deps,
    spectrum_gov: &CanonicalAddr,
    address: &Addr
) -> StdResult<SpecGovBalanceResponse> {
    deps.querier.query(&QueryRequest::Wasm(WasmQuery::Smart {
        contract_addr: deps.api.addr_humanize(spectrum_gov)?.to_string(),
        msg: to_binary(&SpecGovQueryMsg::balance {
