...
pub fn instantiate(
    ...
    store_config(
        ...
        &Config {
            ...
            terra_name_service_token: deps.api.addr_canonicalize(&msg.terra_name_service_token)?,
            terra_name_service_staking: deps.api.addr_canonicalize(&msg.terra_name_service_staking)?,
            terra_name_service_gov: deps.api.addr_canonicalize(&msg.terra_name_service_gov)?,
...
fn query_config(deps: Deps) -> StdResult<ConfigInfo> {
    ...
    let resp = ConfigInfo {
        ...
        terra_name_service_token: deps.api.addr_humanize(&config.terra_name_service_token)?.to_string(),
        terra_name_service_staking: deps.api.addr_humanize(&config.terra_name_service_staking)?.to_string(),
        spectrum_gov: deps.api.addr_humanize(&config.spectrum_gov)?.to_string(),
        terra_name_service_gov: deps.api.addr_humanize(&config.terra_name_service_gov)?.to_string(),
