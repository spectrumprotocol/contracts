...
use terrafloki::pair::SimulationResponse;

use terrafloki::staking::StakerInfoResponse as TerraflokiStakerInfoResponse;
...
pub struct WasmMockQuerier {
    ...
    terrafloki_factory_querier: TerraflokiFactoryQuerier,
}
...
#[derive(Clone, Default)]
pub struct TerraflokiFactoryQuerier {
    pairs: HashMap<String, PairInfo>,
}

impl TerraflokiFactoryQuerier {
    pub fn new(pairs: &[(&String, &PairInfo)]) -> Self {
        TerraflokiFactoryQuerier {
            ...
            QueryRequest::Wasm(WasmQuery::Smart { contract_addr, msg }) => {
                match from_binary(msg).unwrap() {
                    ...
                    MockQueryMsg::Pair { asset_infos } => {
                        ...
                        match self.terrafloki_factory_querier.pairs.get(&key) {
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier<TerraQueryWrapper>) -> Self {
        WasmMockQuerier {
            ...
            terrafloki_factory_querier: TerraflokiFactoryQuerier::default(),
        }
    }
    ...
    pub fn with_terraswap_pairs(&mut self, pairs: &[(&String, &PairInfo)]) {
        self.terrafloki_factory_querier = TerraflokiFactoryQuerier::new(pairs);
    }
}
