...
pub struct Config {
    ...
    pub terrafloki_factory: CanonicalAddr,
    pub spectrum_token: CanonicalAddr,
    pub spectrum_gov: CanonicalAddr,
    pub terrafloki_token: CanonicalAddr,
    pub terrafloki_ticket: CanonicalAddr,
    pub terrafloki_staking: CanonicalAddr,
    pub terrafloki_ticket_farm: CanonicalAddr,
