...
pub struct State {
    ...
    // current reward token rewards in share
...
pub struct PoolInfo {
    ...
    // Gov proxy contract address, if null then auto-stake is disabled
    ...
    // current reward token reward share for the pool
    ...
    // total reward token rewards in share per total_stake_bond_share
    ...
    // number of reward token to reinvest
    pub reinvest_allowance: Uint128,

    // number of ASTRO token to reinvest
    pub reinvest_allowance_astro: Uint128,
}
...
pub struct RewardInfo {
    ...
    // = new reward token rewards for auto-stake
    pub farm_share_index: Decimal,
    ...
    // current reward token rewards in share balance
    pub farm_share: Uint128,
